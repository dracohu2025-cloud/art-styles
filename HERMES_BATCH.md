...
7. Youthful original characters only. **No IP lookalikes, no porn, no politics.**
   - **Subject vehicle (character only):** prefer anime-leaning **youthful, pretty, lively, cute** female OC — bright expression, approachable charm. Do **not** default to solemn / tragic / stiff “museum heroine” faces.
   - **Style exploration stays free:** character vibe must **NOT** constrain art-style range. Dark neon, mezzotint, scratchboard, heavy chiaroscuro, grain, void backgrounds, etc. are all welcome — put the cute lively girl *into* those techniques.
   - Pose & face: smile or bright eyes / lively body language when it fits; never force a sunny pastel look just to make the character cute.
